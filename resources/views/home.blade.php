    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 text-center">
                <img src="https://placehold.co/600x400/e0f2fe/1e3a8a?text=Smart-MedBox+Device" 
                     alt="Smart MedBox" class="img-fluid rounded-4 shadow-lg">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100 rounded-4 p-4 text-center">
                    ...
                    <p class="text-muted">Pantau jumlah obat secara akurat dan dapatkan notifikasi saat stok menipis.</p>
                </div>
            </div>
            <!-- Feature 2 -->
            <div class="col-md-4">
...
<section class="py-5 bg-white">
    <div class="container text-center">
        ...
        <p class="lead text-muted mb-4">Bergabunglah dengan ribuan pengguna yang sudah merasakan manfaat Smart-MedBox.</p>
